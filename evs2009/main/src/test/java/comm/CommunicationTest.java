...
public class CommunicationTest {
	...
	public void testSOAP() throws Exception {
		...
		ArrayList<ProtocolPlugin> cplugins1 = new ArrayList<ProtocolPlugin>();
		// Hier entsteht ein Fehler, da hier der selbe Socket noch einmal initialisiert.
		// Lösung: umbenennen des Sockets -> Hier wird einfach eine 1 angehängt um diesen Fehler zu umgehen
		//cplugins.add(new comm.socket.SocketPlugin(12345));
		cplugins1.add(new comm.soap.SOAPPlugin(23456));
		RequestHandler crh = new RequestHandler(cplugins1);
